...
def import_clerk_interview_from_excel(file, sheet_name="Sheet1"):
    ...
    col_map = [
        ...
        ("optimization_status", ["Optimization Status", "OptimizationStatus", "optimization_status"]),
        ("strength", ["Strength", "Stringth", "strength"]),
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ClerkInterviewTracking.objects.create(
                ...
                optimization_status=_normalize_col(get_val("optimization_status")) or "",
                strength=_normalize_col(get_val("strength")) or "",
